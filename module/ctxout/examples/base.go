		...
		ctxout.PrintLn(
			...
			ctxout.Table(
				ctxout.Row(
					ctxout.TD(
						rndWord1,
						ctxout.Prop(ctxout.ATTR_SIZE, 10),
						ctxout.Prop(ctxout.ATTR_ORIGIN, 2),
						ctxout.Prop(ctxout.ATTR_PREFIX, ctxout.ForeLightBlue),
						ctxout.Prop(ctxout.ATTR_SUFFIX, ctxout.ResetCode),
					),

					ctxout.TD(
						rndWord2,
						ctxout.Prop(ctxout.ATTR_SIZE, 50),
						ctxout.Prop(ctxout.ATTR_ORIGIN, 1),
					),

					ctxout.TD(
						rndWord3,
						ctxout.Prop(ctxout.ATTR_SIZE, 40),
						ctxout.Prop(ctxout.ATTR_ORIGIN, 2),
						ctxout.Prop(ctxout.ATTR_PREFIX, ctxout.BackCyan+ctxout.ForeLightYellow),
						ctxout.Prop(ctxout.ATTR_SUFFIX, ctxout.ResetCode),
					),
				),
			),
			...
			ctxout.Table(
				ctxout.Row(
					ctxout.TD(
						...
						ctxout.Prop(ctxout.ATTR_SIZE, 10),
						ctxout.Prop(ctxout.ATTR_ORIGIN, 2),
						ctxout.Prop(ctxout.ATTR_PREFIX, oddBackground+ctxout.ForeWhite),
						ctxout.Prop(ctxout.ATTR_SUFFIX, ctxout.ResetCode),
					),
					...
					ctxout.TD(
						...
						ctxout.Prop(ctxout.ATTR_SIZE, 50),
						ctxout.Prop(ctxout.ATTR_ORIGIN, 1),
						ctxout.Prop(ctxout.ATTR_OVERFLOW, ctxout.OVERFLOW_WORDWRAP),
						ctxout.Prop(ctxout.ATTR_PREFIX, oddBackground+ctxout.ForeDarkGrey),
						ctxout.Prop(ctxout.ATTR_SUFFIX, ctxout.ResetCode),
					),
					...
					ctxout.TD(
						...
						ctxout.Prop(ctxout.ATTR_ORIGIN, 2),
						ctxout.Prop(ctxout.ATTR_OVERFLOW, ctxout.OVERFLOW_WORDWRAP),
						ctxout.Prop(ctxout.ATTR_PREFIX, oddBackground+ctxout.ForeLightYellow),
						ctxout.Prop(ctxout.ATTR_SUFFIX, ctxout.ResetCode),
					),
				),
			),
